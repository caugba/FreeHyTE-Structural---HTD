...
if exist('./StructDef.mat','file')
    load('StructDef','L','B','Nx','Ny','EdgesOrder','LoopsOrder',...
        'NumberGaussPoints','RunOption','MeshOption','Young','Poisson','PlaneState');
...
save('StructDef','L','B','Nx','Ny','EdgesOrder','LoopsOrder',...
    'NumberGaussPoints','RunOption','MeshOption','Young','Poisson','PlaneState','p','t',...
    'edgesArray','ChangesQ');
